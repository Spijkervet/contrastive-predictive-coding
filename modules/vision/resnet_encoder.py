...
from .weight_init import makeDeltaOrthogonal
    ...
    def __init__(
        ...
        if encoder_num == 0:
            self.model.add_module(
                "Conv1",
                nn.Conv2d(
                    input_dim, self.filter[0], kernel_size=5, stride=1, padding=2
                ),
            )
        ...
        self.loss = InfoNCE(
            args, in_channels=self.in_planes, out_channels=self.in_planes
        )
